...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/Learners-Academym'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="/Learners-Academy/Dashboard.jsp">Dashboard</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
...
<%} else{
response.sendRedirect("/Learners-Academy/Dashboard.jsp");
%>
