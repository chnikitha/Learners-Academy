...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/Learners-Academy'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="LogoutController">logout</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
...
<tr><td>&nbsp;&nbsp;<a href="ManageStudent1">manage students</a>&nbsp;&nbsp;</td><td> Get a list of all students
<br/>Add New Students
<br/>Update Student Details
<br/>Delete an existing student</td></tr>
<tr><td>&nbsp;&nbsp;<a href="ManageClasses1">manage classes</a>&nbsp;&nbsp;</td><td> Get a list of all Classes
<br/>Add New Class
<br/>Delete an existing Class
<br/>Generate Class Report</td></tr>
<tr><td>&nbsp;&nbsp;<a href="ManageTeacher1">manage teachers</a>&nbsp;&nbsp;</td><td> Get a list of all Teachers
<br/>Add New Teachers
<br/>Update Teacher Details
<br/>Delete an existing Teacher</td></tr>
<tr><td>&nbsp;&nbsp;<a href="ManageSubject1">manage subjects</a>&nbsp;&nbsp;</td><td> Get a list of all Subjects
<br/>Add New Subject
